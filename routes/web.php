...
Route::group(['middleware' => ['lang']], function () {
    ...
    Route::get('/dosen', [LandingPageController::class, 'Dosen']);
    ...
    Route::get('/dosen/AR', [LandingPageController::class, 'AR']);
    Route::get('/dosen/DV', [LandingPageController::class, 'DV']);
    Route::get('/dosen/MN', [LandingPageController::class, 'MN']);
    Route::get('/dosen/YJ', [LandingPageController::class, 'YJ']);
    Route::get('/dosen/LR', [LandingPageController::class, 'LR']);
    Route::get('/dosen/DP', [LandingPageController::class, 'DP']);
    Route::get('/dosen/KA', [LandingPageController::class, 'KA']);
    Route::get('/dosen/LA', [LandingPageController::class, 'LA']);
    Route::get('/dosen/KH', [LandingPageController::class, 'KH']);
    Route::get('/dosen/AL', [LandingPageController::class, 'AL']);
    Route::get('/dosen/BF', [LandingPageController::class, 'BF']);
    Route::get('/dosen/DA', [LandingPageController::class, 'DA']);
    Route::get('/dosen/EF', [LandingPageController::class, 'EF']);
    Route::get('/dosen/FQ', [LandingPageController::class, 'FQ']);
    Route::get('/dosen/UA', [LandingPageController::class, 'UA']);
    Route::get('/dosen/AS', [LandingPageController::class, 'AS']);
    Route::get('/dosen/RJ', [LandingPageController::class, 'RJ']);
    Route::get('/dosen/MF', [LandingPageController::class, 'MF']);
    Route::get('/dosen/AL', [LandingPageController::class, 'AL']);
    Route::get('/dosen/HI', [LandingPageController::class, 'HI']);
...
Route::group(['middleware' => ['admin']], function () {
    ...
    // Dosen
    Route::get('/listDosen', [PostController::class, 'listDosen']);
    Route::get('/addDosen', [PostController::class, 'AddDosen']);
    // Route::post('/addPostProgress', [PostController::class, 'AddPostProgress'])->name('thumbnail.upload.post');
    // Route::get('/editPost/{id}', [PostController::class, 'EditPost']);
    // Route::post('/editPostProgress', [PostController::class, 'EditPostProgress'])->name('thumbnail.edit.upload.post');
    // Route::get('/deletePost/{id}', [PostController::class, 'DeletePost']);
