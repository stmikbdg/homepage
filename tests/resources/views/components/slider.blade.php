...
<div class="hero-area">
    <div class="hero-slideshow owl-carousel">
        ...
        <div class="single-slide bg-img">
            <!-- Background Image-->
            <div class="slide-bg-img bg-img bg-overlay" style="background-image: url(<?=asset('core/public/assets/img/bg-img')."/".$slide->post_thumbnail ?>);">
            </div>
            <!-- Welcome Text -->
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center">
                    ...
                    <div class="col-12 col-md-6 d-none d-lg-block">
                        <img style="width: 80%;" data-animation="fadeInRight" data-delay="100ms" class="rounded" src="{{ asset('core/public/assets/img/bg-img') }}/{{ $slide->post_thumbnail }}" />
                    </div>
                </div>
            </div>
