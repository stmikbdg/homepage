    ...
    <header class="header-area bg-dark-blue">
            ...
            <div class="row align-items-center py-2">
                ...
                <div class="col-4 col-lg-6 text-right text-light">
                    <a class="pl-1" href="{{ @URL::to('/id') }}" title="Indonesia">
                        <img src="{{ asset('core/public/assets/img/lang-img/Indonesia.png') }}" width="25" height="auto" />
                    </a>
                    <a class="pl-1" href="{{ @URL::to('/en') }}" title="English">
                        <img src="{{ asset('core/public/assets/img/lang-img/English.png') }}" width="25" height="auto" />
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center">
                    <div class="col-12 col-md-3">
                        ...
                        <div class="logo">
                            <a href="{{ @URL::to('/') }}">
                                <img src="{{ asset('core/public/assets/img/core-img/logo-title.png') }}" width="150" />
                            </a>
                        </div>
                    </div>
                    <div class="col-12 col-md-9 my-3" align="center">
                        ...
                        <div class="logo">
                            <a href="{{ @URL::to('/') }}">
                                <img src="{{ asset('core/public/assets/img/core-img/subtitle.png') }}" width="500" />
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="credit-main-menu" id="sticker">
                ...
                <div class="container">
                    <div class="row no-gutters align-items-center">
                        <nav class="col-2 d-none d-lg-block">
                            <a href="{{ @URL::to('/') }}">
                                <img src="{{ asset('core/public/assets/img/core-img/logo_stmik_kampusmerdeka.png') }}" />
                            </a>
                        </nav>
                        <!-- Menu -->
                        <nav class="col-12 col-lg-9 classy-navbar justify-content-center" id="creditNav">
                            ...
                            <div class="d-block d-lg-none w-100" align="center">
                                <a class="pr-2" href="{{ @URL::to('/') }}">
                                    <img width="80" src="{{ asset('core/public/assets/img/core-img/logo-title.png') }}" />
                                </a>
                                <a class="pl-2" href="{{ @URL::to('/') }}">
                                    <img width="80" src="{{ asset('core/public/assets/img/logo-img/kampus_merdeka.png') }}" />
                                </a>
                            </div>
            ...
            <div class="position-absolute logo-center">
                <a href="{{ @URL::to('/') }}">
                    <img src="{{ asset('core/public/assets/img/core-img/logo.png') }}" alt="" style="margin: 25px;">
                </a>
            </div>
            -->
        </div>
