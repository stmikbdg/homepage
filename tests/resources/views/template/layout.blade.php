...
<head>
    ...
    <meta property="og:image" content="{{ URL::to('core/public/assets/img/core-img/logo.png') }}" />
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{ asset('core/public/assets/img/core-img/logo2.png') }}">
...
<body class="bg-light">
    ...
    <!-- jQuery-2.2.4 js -->
    <script src="{{ asset('core/public/assets/js/jquery/jquery-2.2.4.min.js') }}"></script>
    <!-- Popper js -->
    <script src="{{ asset('core/public/assets/js/bootstrap/popper.min.js') }}"></script>
    <!-- Bootstrap js -->
    <script src="{{ asset('core/public/assets/js/bootstrap/bootstrap.min.js') }}"></script>
    <!-- Instafeed -->
    <script src="https://cdn.jsdelivr.net/gh/stevenschobert/instafeed.js@2.0.0rc1/src/instafeed.min.js"></script>
    <!-- All Plugins js -->
    <script src="{{ asset('core/public/assets/js/plugins/plugins.js') }}"></script>
    <!-- Active js -->
    <script src="{{ asset('core/public/assets/js/active.js') }}"></script>
    <!-- Ionicons js -->
