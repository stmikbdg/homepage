                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-6 col-md-4 mt-4">
                            <div class="row justify-content-center align-items-center">
                                <div class="col-lg-4">
                                    <img src="{{ asset('core/public/assets/img/leader-img') }}/{{ LP::getPimpinan('761b3b421d', 'pimpinan_image') }}" />
                                </div>
                        ...
                        <div class="col-6 col-md-4 mt-4">
                            <div class="row justify-content-center align-items-center">
                                <div class="col-lg-4">
                                    <img src="{{ asset('core/public/assets/img/leader-img') }}/{{ LP::getPimpinan('e6c6908020', 'pimpinan_image') }}" />
                                </div>
                                <div class="col-lg-8 mt-4">
                                    <div class="section-heading text-dark">
                                        <div class="line"></div>
                        ...
                        <div class="col-6 col-md-4 mt-4">
                            <div class="row justify-content-center align-items-center">
                                <div class="col-lg-4">
                                    <img src="{{ asset('core/public/assets/img/leader-img') }}/{{ LP::getPimpinan('acd792343c', 'pimpinan_image') }}" />
                                </div>
                                <div class="col-lg-8 mt-4">
                                    <div class="section-heading text-dark">
                                        <div class="line"></div>
                        ...
                        <div class="col-6 col-md-4 mt-4">
                            <div class="row justify-content-center align-items-center">
                                <div class="col-lg-4">
                                    <img src="{{ asset('core/public/assets/img/leader-img') }}/{{ LP::getPimpinan('d9c6a99872', 'pimpinan_image') }}" />
                                </div>
                                <div class="col-lg-8 mt-4">
                                    <div class="section-heading text-dark">
                                        <div class="line"></div>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-7 mt-4">
                            <div class="row justify-content-center" align="center">
                                <div class="col-lg-4">
                                    <img src="{{ asset('core/public/assets/img/leader-img') }}/{{ LP::getPimpinan('6c600ae5d0', 'pimpinan_image') }}" />
                                </div>
                                <div class="col-lg-8 mt-4">
                        ...
                        <div class="col-6 mt-4">
                            <div class="row justify-content-center">
                                <div class="col-lg-4">
                                    <img src="{{ asset('core/public/assets/img/leader-img') }}/{{ LP::getPimpinan('9a5fc59d89', 'pimpinan_image') }}" />
                                </div>
                                <div class="col-lg-8 mt-4">
                                    <div class="section-heading text-light">
                                        <div class="line"></div>
                        ...
                        <div class="col-6 mt-4">
                            <div class="row justify-content-center">
                                <div class="col-lg-4">
                                    <img src="{{ asset('core/public/assets/img/leader-img') }}/{{ LP::getPimpinan('5d86297213', 'pimpinan_image') }}" />
                                </div>
                                <div class="col-lg-8 mt-4">
                                    <div class="section-heading text-light">
                                        <div class="line"></div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-12 mt-4">
                            <div class="row justify-content-center">
                                <div class="col-4 col-lg-4">
                                    <img src="{{ asset('core/public/assets/img/leader-img') }}/{{ LP::getPimpinan('8588e47604', 'pimpinan_image') }}" />
                                </div>
                        ...
                        <div class="col-12 mt-4">
                            <div class="row justify-content-center">
                                <div class="col-4 col-lg-4">
                                    <img src="{{ asset('core/public/assets/img/leader-img') }}/{{ LP::getPimpinan('1378cc7154', 'pimpinan_image') }}" />
                                </div>
                                <div class="col-8 col-lg-8">
                                    <div class="section-heading text-dark">
                                        <div class="line"></div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-12 mt-4">
                            <div class="row justify-content-center">
                                <div class="col-4 col-lg-4">
                                    <img src="{{ asset('core/public/assets/img/leader-img') }}/{{ LP::getPimpinan('99c5daf92f', 'pimpinan_image') }}" />
                                </div>
                                <div class="col-8 col-lg-8">
                                    <div class="section-heading text-dark">
                                        <div class="line"></div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-12 mt-4">
                            <div class="row justify-content-center">
                                <div class="col-4 col-lg-4">
                                    <img src="{{ asset('core/public/assets/img/leader-img') }}/{{ LP::getPimpinan('5554d1f9ef', 'pimpinan_image') }}" />
                                </div>
                                <div class="col-8 col-lg-8">
                                    <div class="section-heading text-dark">
                                        <div class="line"></div>
