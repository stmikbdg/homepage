...
<script src="{{ asset('core/public/assets/admin/plugins/jquery-countto/jquery.countTo.js') }}"></script>
<!-- Chart JS-->
<script src="{{ asset('core/public/assets/admin/plugins/chartjs/Chart.bundle.js') }}"></script>
