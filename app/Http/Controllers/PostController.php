...
class PostController extends Controller
{
    ...
    {
        $datas = DB::table('stmik_post')
        -> join('stmik_category', 'stmik_category.category_id', '=' , 'stmik_post.post_category')
        -> join('stmik_users', 'stmik_users.users_id', '=' , 'stmik_post.post_author')
        ->orderby('post_date_created' , 'desc')->get();
        return view('content/admin/listPost' , compact ('datas'));
    }
    ...
    //yang di bawah khusus dosen
    
        public function listDosen()
    {
        return view("content/admin/listDosen");
    }
    
        public function AddDosen()
    {
     
        return view("content/admin/addDosen");
    }
