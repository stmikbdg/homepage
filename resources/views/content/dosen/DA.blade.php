...
@media only screen and (max-width: 768px) {
	...
	<div class="kotak">
		...
		<div class="blok">		
			...
			<div class="kiri">
				<img src="{{asset("/assets/dosen/DA.jpg")}}">				
			</div>
 
			<div class="kanan">
                <h3 style="margin-top: 0px;margin-bottom: 0px;">Dedy Apriadi, M.S.i</h3>
    ...
    <div class="blok">
        <div>
            <table class="table table-hover">
                ...
                <tr>
                    <td>KD1207</td>
                    <td>Sistem Informasi Managemen</td>
                </tr>
                <tr>
                    <td>KD1310</td>
                ...
                <tr>
                    <td>KD1205</td>
                    <td>Matriks dan Ruang Vector</td>
                </tr>
                <tr>
                    <td>IF1709</td>
    ...
    <div class="block">
        <div>
            <table class="table table-hover">
                <tr>
                    <td>2003</td>
                    <td>Bachelor of Science at STMIK Bandung</td>
                </tr>
                <tr>
                    <td>2007</td>
                    <td>Master of Science at STMIK Bandung</td>
                </tr>
            </table>
        </div>
      </div>
