...
@media only screen and (max-width: 768px) {
	...
	<div class="kotak">
		...
		<div class="blok">		
			...
			<div class="kiri">
				<img src="{{asset("/assets/dosen/EF.jpg")}}">				
			</div>
 
			<div class="kanan">
                <h3 style="margin-top: 0px;margin-bottom: 0px;">Erfizal Fikri Yusmansyah, M.S.i</h3>
			    ...
			    <p style="margin-top: 0px;margin-bottom: 0px;"><b>Research : </b> Organizational Leadership Strategies in Improving the Quality of School Education in the Digital Era.</p>
