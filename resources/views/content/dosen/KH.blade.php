...
@media only screen and (max-width: 768px) {
	...
	<div class="kotak">
		...
		<div class="blok">		
			...
			<div class="kiri">
				<img src="{{asset("/assets/dosen/KH.jpg")}}">				
			</div>
 
			<div class="kanan">
                <h3 style="margin-top: 0px;margin-bottom: 0px;">Kushandoyo Ariono, S.T </h3>
			    <p style="margin-top: 0px;margin-bottom: 0px;">A Physics Lecturer</p></label>
    ...
    <div class="blok">
        <div>
            <table class="table table-hover">
                <tr>
                    <td>2009</td>
                    <td>Lecturer Physics at STMIK Bandung</td>
                </tr>
            </table>
    ...
    <div class="block">
        <div>
            <table class="table table-hover">
                <tr>
                    <td>1979</td>
                    <td>Bachelor of Mining Metallurgy at ITB</td>
                </tr>
            </table>
        </div>
      </div>
