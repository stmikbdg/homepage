...
@media only screen and (max-width: 768px) {
	...
	<div class="kotak">
		...
		<div class="blok">		
			...
			<div class="kiri">
			<img src="{{asset("/assets/dosen/HG.jpg")}}">
			</div>
 
			<div class="kanan">
                <h3 style="margin-top: 0px;margin-bottom: 0px;">Herna Gunawan</h3>
			    ...
			    <p style="margin-top: 0px;margin-bottom: 0px;"><b>Research : </b>SISTEM INFORMASI MANAJEMEN DISTRIBUSI (STUDI KASUS : PT ARDERAMA MANDIRI)</p>
    ...
    <div class="block">
        <div>
            <table class="table table-hover">
                <tr>
                    <td>2001</td>
                    <td>Bachelor of Engineering at Sekolah Tinggi Teknologi Indonesia Tanjung Pinang</td>
                </tr>
