                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover dataTable" id="table">
                                        ...
                                        <tbody>
                                             @foreach ($datas as $d)
                                                <tr>
                                                    <td><img src="{{asset('assets')}}/img/bg-img/{{ $d->post_thumbnail }}" alt="" srcset="" width="100px"></td>
                                                    <td>{{$d -> post_title_id}}</td>
                                                    <td>{{$d -> category_title_id }}</td>
                                                    <td>{{$d -> users_name}}</td>
                                                    <td>{{$d -> post_date_created}}</td>
                                                    <td>{{$d -> post_date_updated}}</td>
                                                    <td>
