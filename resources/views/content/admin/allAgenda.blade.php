...
<script>
    ...
    $(function() {
        table.DataTable({
            ...
            columns: [{
                    data: 'agenda_title_id',
                    name: 'agenda_title_id',
                },
                {
                    data: 'agenda_location',
                ...
                {
                    data: 'agenda_date_created',
                    name: 'agenda_date_created'
                },
                {
                    data: 'agenda_date_updated',
                    name: 'agenda_date_updated'
                },
                {
                    data: 'act',
                    name: 'act',
